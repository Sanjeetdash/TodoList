 ...
 <div class="container my-3">
        ...
        <div class="row">
	        ...
	        <h1 style="margin-left:30px; color:white;"> </h1>
                    ...
                    <input type="text" class="form-control mb-3" name="email" value="${data.email}">
                    
                    
                    <input type="Submit"  name="submit" value="Update" class="mb-3 btnn" style="display: block; margin: auto; padding:5px; border-radius: 5px;">
                </form>
                </div>
            <div class="col-md-4">
